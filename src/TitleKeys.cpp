...
*/
void TitleKeys::extractTitleKeys(std::string &keyDirectory)
{
	std::string keyExtractedFile = keyDirectory + "extracted.bin";
	extractTitleKeysTo(keyExtractedFile.c_str());
}
